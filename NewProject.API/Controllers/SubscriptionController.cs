...
namespace NewProject.API.Controllers
{
    ...
    public class SubscriptionController : ControllerBase
    {
        ...
        [HttpPut("Update/{id}")]
        [ProducesResponseType(200, Type = typeof(ReturnObject))]
        public async Task<IActionResult> Update([FromBody]SubscriptionFm param, [FromRoute]int id)
        {
        ...
        [HttpPost("All")]
        [ProducesResponseType(200, Type = typeof(ReturnObject))]
        public async Task<IActionResult> GetAll([FromBody] SubscriptionFormModel obj)
        {
